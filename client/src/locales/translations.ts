...
export const translations = {
    cs: {
        ...
        // Settings Dialog
        'settings.defaultOrganization': 'Výchozí organizace',
        'settings.defaultOrgHint': 'Tato organizace bude vybrána automaticky po přihlášení.',
        ...
        'col_amount': 'Částka',
        'col_currency': 'Měna',
        'col_company': 'Společnost',
        'col_exchange': 'Burza',
        'col_price': 'Cena',
        'col_change_pct': 'Změna %',
        'col_trend': 'Trend',
        'col_actions': 'Akce',
